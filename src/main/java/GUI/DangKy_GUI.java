...
//				new JPanel(); 
		...
		chcHienThiMatKhau.setForeground(SystemColor.WHITE);
		chcHienThiMatKhau.setBackground(new Color(0, 0, 0, 150));
	...
	public boolean dangKy() throws SQLException {
		...
		KhachHang kh = new KhachHang(-1, txtTenKH.getText(), txtSoDienThoai.getText(), txtDiaChi.getText());
